...
class Intervals {
	...
	private function get_intervals(): array {
		// add the list.
		$list = array(
			'\ConnectorForPropstack\Plugin\Intervals\Hourly',
			'\ConnectorForPropstack\Plugin\Intervals\Hourly2',
			'\ConnectorForPropstack\Plugin\Intervals\Hourly3',
			'\ConnectorForPropstack\Plugin\Intervals\Hourly4',
			'\ConnectorForPropstack\Plugin\Intervals\Minutely15',
			'\ConnectorForPropstack\Plugin\Intervals\Minutely20',
			'\ConnectorForPropstack\Plugin\Intervals\Minutely30',
			'\ConnectorForPropstack\Plugin\Intervals\Daily',
			'\ConnectorForPropstack\Plugin\Intervals\Weekly',
		);
		 ...
		 */
		return apply_filters( 'cfprop_intervals', $list );
	}

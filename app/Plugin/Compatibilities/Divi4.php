<?php
/**
 * File to handle the compatibility-check for Divi 4.
 *
 ...
 */
class Divi4 extends Compatibilities_Base {
	 ...
	 * @var string
	 */
	protected string $name = 'cfprop_compatibility_divi4';
	 ...
	 * @var ?Divi4
	 */
	private static ?Divi4 $instance = null;

	/**
	 * Return the instance of this Singleton object.
	 */
	public static function get_instance(): Divi4 {
	...
	public function check(): void {
		...
		if ( $this->is_active() ) {
			...
			$transient_obj->set_message( sprintf( __( '<strong>We realized that you are using Divi 4 - very nice!</strong> <a href="%1$s" target="_blank"><i>Connector for Propstack Pro</i> (opens a new window)</a> allows you to design the output of your objects in Divi 4.', 'connector-for-propstack' ), esc_url( Helper::get_pro_url() ) ) );
	...
	public function is_active(): bool {
		...
		if ( \ConnectorForPropstack\Plugin\Helper::is_plugin_active( 'divi-builder/divi-builder.php' ) ) {

...
class Languages {
	...
	private function __construct() {
		$this->languages = array(
			'de' => __( 'German', 'connector-for-propstack' ),
			'en' => __( 'English', 'connector-for-propstack' ),
		);
	}
	...
	public function get_languages(): array {
		 ...
		 */
		return apply_filters( 'cfprop_supported_languages', $languages );
	}
	 ...
	 *
	 * @param bool $use_wp_lang True if the returned value should be WP-language.
	 *
	 * @return string
	 */
	...
	public function get_active_languages( bool $with_main_language = true ): array {
		...
		$active_languages = get_option( 'propstack_languages' );
	...
	public function get_fallback_language_name(): string {
		 ...
		 */
		return apply_filters( 'cfprop_fallback_language', $fallback_language );
	}
	 ...
	 *
	 * If our plugin does not support detected language, use the fallback language.
	 *
	 * @return string
	 */
	public function get_current_lang(): string {
		 ...
		 */
		return apply_filters( 'cfprop_current_language', $wp_language );
	}
	...
	public function get_lang_mappings( string $language_name ): array {
		 ...
		 */
		$mapping_languages = apply_filters( 'cfprop_language_mappings', $mapping_languages );
	...
	/**
	 * Return the language title of the given language key.
	 *

<?php
/**
 * File to handle the broker category for fields.
 *
 ...
 */
class Broker extends Field_Category_Base {
	/**
	...
	public function get_label(): string {
		return __( 'Broker', 'connector-for-propstack' );
	}
	...
	public function get_category_type(): Field_Category_Type_Base {
		return new \ConnectorForPropstack\Propstack\FieldCategoryTypes\Broker();
	}
}

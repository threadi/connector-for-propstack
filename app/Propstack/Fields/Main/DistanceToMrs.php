 ...
 */
class DistanceToMrs extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'distance_to_mrs';
	 ...
	 * @var string
	 */
	protected string $name = 'distance_to_mrs';
	...
	public function get_label(): string {
		return __( 'Distance next railway station', 'connector-for-propstack' );
	}

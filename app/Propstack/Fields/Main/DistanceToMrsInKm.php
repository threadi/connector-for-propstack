 ...
 */
class DistanceToMrsInKm extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'distance_to_mrs_in_km';
	 ...
	 * @var string
	 */
	protected string $name = 'distance_to_mrs_in_km';
	...
	public function get_label(): string {
		return __( 'Distance to next railway station in km', 'connector-for-propstack' );
	}

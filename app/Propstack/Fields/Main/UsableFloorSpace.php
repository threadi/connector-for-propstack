 ...
 */
class UsableFloorSpace extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'usable_floor_space';
	 ...
	 * @var string
	 */
	protected string $name = 'usable_floor_space';
	...
	public function get_label(): string {
		return __( 'Usable Floor Space', 'connector-for-propstack' );
	}

 ...
 */
class NumberOfTerraces extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'number_of_terraces';
	 ...
	 * @var string
	 */
	protected string $name = 'number_of_terraces';
	...
	public function get_label(): string {
		return __( 'Amount of terraces', 'connector-for-propstack' );
	}

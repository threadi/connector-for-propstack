 ...
 */
class LongDescriptionNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'long_description_note';
	 ...
	 * @var string
	 */
	protected string $name = 'long_description_note';
	...
	public function get_label(): string {
		return __( 'Long description', 'connector-for-propstack' );
	}

 ...
 */
class OtherCostsVat extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'other_costs_vat';
	 ...
	 * @var string
	 */
	protected string $name = 'other_costs_vat';
	...
	public function get_label(): string {
		return __( 'Other costs VAT', 'connector-for-propstack' );
	}

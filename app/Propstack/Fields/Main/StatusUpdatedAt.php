 ...
 */
class StatusUpdatedAt extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'status_updated_at';
	 ...
	 * @var string
	 */
	protected string $name = 'status_updated_at';
	...
	public function get_label(): string {
		return __( 'Status updated at', 'connector-for-propstack' );
	}

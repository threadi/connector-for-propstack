 ...
 */
class NumberOfBedRooms extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'number_of_bed_rooms';
	 ...
	 * @var string
	 */
	protected string $name = 'number_of_bed_rooms';
	...
	public function get_label(): string {
		return __( 'Amount of bedrooms', 'connector-for-propstack' );
	}

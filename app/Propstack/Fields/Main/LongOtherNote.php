 ...
 */
class LongOtherNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'long_other_note';
	 ...
	 * @var string
	 */
	protected string $name = 'long_other_note';
	...
	public function get_label(): string {
		return __( 'Long other', 'connector-for-propstack' );
	}

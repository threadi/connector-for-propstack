 ...
 */
class PropertySpaceValue extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'property_space_value';
	 ...
	 * @var string
	 */
	protected string $name = 'property_space_value';
	...
	public function get_label(): string {
		return __( 'Property space value', 'connector-for-propstack' );
	}

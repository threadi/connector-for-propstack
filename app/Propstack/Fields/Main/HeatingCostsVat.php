 ...
 */
class HeatingCostsVat extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'heating_costs_vat';
	 ...
	 * @var string
	 */
	protected string $name = 'heating_costs_vat';
	...
	public function get_label(): string {
		return __( 'Heating costs VAT', 'connector-for-propstack' );
	}

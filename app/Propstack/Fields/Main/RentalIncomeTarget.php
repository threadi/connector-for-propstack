 ...
 */
class RentalIncomeTarget extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'rental_income_target';
	 ...
	 * @var string
	 */
	protected string $name = 'rental_income_target';

 ...
 */
class RentalIncomeActual extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'rental_income_actual';
	 ...
	 * @var string
	 */
	protected string $name = 'rental_income_actual';
	...
	public function get_label(): string {
		return __( 'Rental income actual', 'connector-for-propstack' );
	}

 ...
 */
class FlooringType extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'flooring_type';
	 ...
	 * @var string
	 */
	protected string $name = 'flooring_type';
	...
	public function get_label(): string {
		return __( 'Flooring Type', 'connector-for-propstack' );
	}

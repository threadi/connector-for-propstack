 ...
 */
class ServiceCharge extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'service_charge';
	 ...
	 * @var string
	 */
	protected string $name = 'service_charge';
	...
	public function get_label(): string {
		return __( 'Service charge', 'connector-for-propstack' );
	}

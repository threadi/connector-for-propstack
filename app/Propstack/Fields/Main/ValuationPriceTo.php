 ...
 */
class ValuationPriceTo extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'valuation_price_to';
	 ...
	 * @var string
	 */
	protected string $name = 'valuation_price_to';
	...
	public function get_label(): string {
		return __( 'Valuation price to', 'connector-for-propstack' );
	}

 ...
 */
class WellnessArea extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'wellness_area';
	 ...
	 * @var string
	 */
	protected string $name = 'wellness_area';
	...
	public function get_label(): string {
		return __( 'Wellness area', 'connector-for-propstack' );
	}

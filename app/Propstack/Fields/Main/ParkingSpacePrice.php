 ...
 */
class ParkingSpacePrice extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'parking_space_price';
	 ...
	 * @var string
	 */
	protected string $name = 'parking_space_price';
	...
	public function get_label(): string {
		return __( 'Parking Space Price', 'connector-for-propstack' );
	}

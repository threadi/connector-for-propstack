 ...
 */
class DistanceToAirport extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'distance_to_airport';
	 ...
	 * @var string
	 */
	protected string $name = 'distance_to_airport';
	...
	public function get_label(): string {
		return __( 'Distance to airport', 'connector-for-propstack' );
	}

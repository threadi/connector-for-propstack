 ...
 */
class ValuationPriceFrom extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'valuation_price_from';
	 ...
	 * @var string
	 */
	protected string $name = 'valuation_price_from';
	...
	public function get_label(): string {
		return __( 'Valuation price from', 'connector-for-propstack' );
	}

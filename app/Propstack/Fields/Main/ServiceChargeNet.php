 ...
 */
class ServiceChargeNet extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'service_charge_net';
	 ...
	 * @var string
	 */
	protected string $name = 'service_charge_net';
	...
	public function get_label(): string {
		return __( 'Service charge net', 'connector-for-propstack' );
	}

 ...
 */
class TotalFloorSpace extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'total_floor_space';
	 ...
	 * @var string
	 */
	protected string $name = 'total_floor_space';
	...
	public function get_label(): string {
		return __( 'Total Floor space', 'connector-for-propstack' );
	}

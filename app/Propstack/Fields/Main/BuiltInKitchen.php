 ...
 */
class BuiltInKitchen extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'built_in_kitchen';
	 ...
	 * @var string
	 */
	protected string $name = 'built_in_kitchen';
	...
	public function get_label(): string {
		return __( 'Built-in Kitchen', 'connector-for-propstack' );
	}

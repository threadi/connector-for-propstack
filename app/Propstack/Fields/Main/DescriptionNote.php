 ...
 */
class DescriptionNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'description_note';
	 ...
	 * @var string
	 */
	protected string $name = 'description_note';
	...
	public function get_label(): string {
		return __( 'Description Note', 'connector-for-propstack' );
	}

 ...
 */
class BalconySpace extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'balcony_space';
	 ...
	 * @var string
	 */
	protected string $name = 'balcony_space';
	...
	public function get_label(): string {
		return __( 'Balcony space', 'connector-for-propstack' );
	}

 ...
 */
class CreatedAtFormatted extends Field_Base {
	 ...
	 * @var string
	 */
	protected string $api = 'created_at_formatted';
	 ...
	 * @var string
	 */
	protected string $name = 'created_at_formatted';
	...
	public function get_label(): string {
		return __( 'Created at', 'connector-for-propstack' );
	}

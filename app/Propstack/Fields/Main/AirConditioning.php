 ...
 */
class AirConditioning extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'air_conditioning';
	 ...
	 * @var string
	 */
	protected string $name = 'air_conditioning';
	...
	public function get_label(): string {
		return __( 'Air Conditioning', 'connector-for-propstack' );
	}

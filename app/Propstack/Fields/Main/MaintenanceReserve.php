 ...
 */
class MaintenanceReserve extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'maintenance_reserve';
	 ...
	 * @var string
	 */
	protected string $name = 'maintenance_reserve';
	...
	public function get_label(): string {
		return __( 'Maintenance Reserve', 'connector-for-propstack' );
	}

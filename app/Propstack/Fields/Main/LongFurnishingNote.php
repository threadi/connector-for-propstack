 ...
 */
class LongFurnishingNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'long_furnishing_note';
	 ...
	 * @var string
	 */
	protected string $name = 'long_furnishing_note';
	...
	public function get_label(): string {
		return __( 'Long furnishing', 'connector-for-propstack' );
	}

 ...
 */
class DistanceToFmLength extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'distance_to_fm_length';
	 ...
	 * @var string
	 */
	protected string $name = 'distance_to_fm_length';
	...
	public function get_label(): string {
		return __( 'Distance to next speedway as length', 'connector-for-propstack' );
	}

 ...
 */
class OtherCostsNet extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'other_costs_net';
	 ...
	 * @var string
	 */
	protected string $name = 'other_costs_net';
	...
	public function get_label(): string {
		return __( 'Other costs net', 'connector-for-propstack' );
	}

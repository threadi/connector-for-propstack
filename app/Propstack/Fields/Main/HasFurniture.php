 ...
 */
class HasFurniture extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'has_furniture';
	 ...
	 * @var string
	 */
	protected string $name = 'has_furniture';
	...
	public function get_label(): string {
		return __( 'Has Furniture', 'connector-for-propstack' );
	}

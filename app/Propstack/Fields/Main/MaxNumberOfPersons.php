 ...
 */
class MaxNumberOfPersons extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'max_number_of_persons';
	 ...
	 * @var string
	 */
	protected string $name = 'max_number_of_persons';
	...
	public function get_label(): string {
		return __( 'Max. amount of persons', 'connector-for-propstack' );
	}

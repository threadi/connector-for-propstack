 ...
 */
class HeatingCosts extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'heating_costs';
	 ...
	 * @var string
	 */
	protected string $name = 'heating_costs';
	...
	public function get_label(): string {
		return __( 'Heating costs', 'connector-for-propstack' );
	}

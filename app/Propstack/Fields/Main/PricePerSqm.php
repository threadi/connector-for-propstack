 ...
 */
class PricePerSqm extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'price_per_sqm';
	 ...
	 * @var string
	 */
	protected string $name = 'price_per_sqm';
	...
	public function get_label(): string {
		return __( 'Price per SQM', 'connector-for-propstack' );
	}

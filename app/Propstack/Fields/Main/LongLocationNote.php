 ...
 */
class LongLocationNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'long_location_note';
	 ...
	 * @var string
	 */
	protected string $name = 'long_location_note';
	...
	public function get_label(): string {
		return __( 'Long Location', 'connector-for-propstack' );
	}

 ...
 */
class NumberOfUnits extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'number_of_units';
	 ...
	 * @var string
	 */
	protected string $name = 'number_of_units';
	...
	public function get_label(): string {
		return __( 'Amount units', 'connector-for-propstack' );
	}

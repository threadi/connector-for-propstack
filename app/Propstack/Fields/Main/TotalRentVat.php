 ...
 */
class TotalRentVat extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'total_rent_vat';
	 ...
	 * @var string
	 */
	protected string $name = 'total_rent_vat';
	...
	public function get_label(): string {
		return __( 'Total rent VAT', 'connector-for-propstack' );
	}

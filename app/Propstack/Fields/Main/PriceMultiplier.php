 ...
 */
class PriceMultiplier extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'price_multiplier';
	 ...
	 * @var string
	 */
	protected string $name = 'price_multiplier';
	...
	public function get_label(): string {
		return __( 'Price Multiplier', 'connector-for-propstack' );
	}

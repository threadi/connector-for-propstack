 ...
 */
class KitchenComplete extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'kitchen_complete';
	 ...
	 * @var string
	 */
	protected string $name = 'kitchen_complete';
	...
	public function get_label(): string {
		return __( 'Kitchen complete', 'connector-for-propstack' );
	}

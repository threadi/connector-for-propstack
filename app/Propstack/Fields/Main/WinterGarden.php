 ...
 */
class WinterGarden extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'winter_garden';
	 ...
	 * @var string
	 */
	protected string $name = 'winter_garden';
	...
	public function get_label(): string {
		return __( 'Winter garden', 'connector-for-propstack' );
	}

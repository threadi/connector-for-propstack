 ...
 */
class SwimmingPool extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'swimming_pool';
	 ...
	 * @var string
	 */
	protected string $name = 'swimming_pool';
	...
	public function get_label(): string {
		return __( 'Swimming Pool', 'connector-for-propstack' );
	}

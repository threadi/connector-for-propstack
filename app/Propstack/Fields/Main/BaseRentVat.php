 ...
 */
class BaseRentVat extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'base_rent_vat';
	 ...
	 * @var string
	 */
	protected string $name = 'base_rent_vat';
	...
	public function get_label(): string {
		return __( 'Base rent VAT', 'connector-for-propstack' );
	}

 ...
 */
class TotalRentNet extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'total_rent_net';
	 ...
	 * @var string
	 */
	protected string $name = 'total_rent_net';
	...
	public function get_label(): string {
		return __( 'Total rent net', 'connector-for-propstack' );
	}

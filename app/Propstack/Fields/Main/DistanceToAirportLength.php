 ...
 */
class DistanceToAirportLength extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'distance_to_airport_length';
	 ...
	 * @var string
	 */
	protected string $name = 'distance_to_airport_length';
	...
	public function get_label(): string {
		return __( 'Distance to airport as length', 'connector-for-propstack' );
	}

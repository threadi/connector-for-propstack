 ...
 */
class NumberOfBalconies extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'number_of_balconies';
	 ...
	 * @var string
	 */
	protected string $name = 'number_of_balconies';
	...
	public function get_label(): string {
		return __( 'Amount of balconies', 'connector-for-propstack' );
	}

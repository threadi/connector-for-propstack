 ...
 */
class FurnishingNote extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'furnishing_note';
	 ...
	 * @var string
	 */
	protected string $name = 'furnishing_note';
	...
	public function get_label(): string {
		return __( 'Furnishing', 'connector-for-propstack' );
	}

 ...
 */
class EndRentalDate extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'end_rental_date';
	 ...
	 * @var string
	 */
	protected string $name = 'end_rental_date';
	...
	public function get_label(): string {
		return __( 'End rental date', 'connector-for-propstack' );
	}

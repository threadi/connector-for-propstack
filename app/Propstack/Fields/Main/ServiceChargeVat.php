 ...
 */
class ServiceChargeVat extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'service_charge_vat';
	 ...
	 * @var string
	 */
	protected string $name = 'service_charge_vat';
	...
	public function get_label(): string {
		return __( 'Service charge VAT', 'connector-for-propstack' );
	}

 ...
 */
class HeatingCostsNet extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'heating_costs_net';
	 ...
	 * @var string
	 */
	protected string $name = 'heating_costs_net';
	...
	public function get_label(): string {
		return __( 'Heating costs net', 'connector-for-propstack' );
	}

 ...
 */
class Thumbnail extends Field_Base {
	/**
	 * The API name of the field.
	 *
	 * @var string
	 */
	protected string $api = 'avatar_url';
	 ...
	 * @var string
	 */
	protected string $name = 'thumbnail_id';
	 ...
	 * @var string
	 */
	protected string $output_format = 'thumbnail';
	...
	public function get_label(): string {
		return __( 'Image', 'connector-for-propstack' );
	}

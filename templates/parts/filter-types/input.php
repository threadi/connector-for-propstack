...
<fieldset>
	...
	<input type="text" value="<?php echo esc_attr( $interface->get_value() ); ?>" id="cfprop-filter-<?php echo esc_attr( $interface->get_filter_name() ); ?>" name="filter[<?php echo esc_attr( $interface->get_filter_name() ); ?>]" placeholder="<?php echo esc_attr( $interface->get_placeholder() ); ?>">
</fieldset>

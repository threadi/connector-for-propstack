<?php
/**
 * File for tests against the pagination of the API v1 object import.
 *
...
/**
 * Object for tests against the pagination of \ConnectorForPropstack\Propstack\Imports\v1\Objects.
 *
 * The shared test case only mocks the API v1 URL. This class registers its own
 * page-aware mock for the v1 endpoint (https://api.propstack.de/v1/units):
...
class ObjectsPagination extends ConnectorForPropstackTestCase {
	...
	public function set_up(): void {
		...
		// register the page-aware mock for the v1 endpoint.
	...
	private function run_import( int $total, ?int $per = null ): void {
		...
		( new \ConnectorForPropstack\Propstack\Imports\v1\Objects() )->run();

<?php
/**
 * File for tests against the cleanup safety of \ConnectorForPropstack\Propstack\Imports\v2\Objects.
 *
...
/**
 * Object for tests against the cleanup safety of the object import via API v2.
 *
 ...
 *
 * Hint: the shared test case does not mock the v2 properties URL, so this class registers
 * its own page-aware mock for it.
 */
class CleanupSafety extends ConnectorForPropstackTestCase {
	...
	public function set_up(): void {
		...
		add_filter( 'pre_http_request', array( $this, 'mock_v2_request' ), 20, 3 );
	...
	public function tear_down(): void {
		remove_filter( 'pre_http_request', array( $this, 'mock_v2_request' ), 20 );
	...
	public function mock_v2_request( false|array|WP_Error $result, array $parsed_args, string $url ): false|array|WP_Error {
		...
		// build the slice of this page in the v2 format (the title is a string).
		$slice = array();

...
This repository provides the features for the free version of the WordPress plugin _Connector for Propstack_. The repository is used as a basis for deploying the plugin to the WordPress repository. It is not intended to run as a plugin as it is, even if that is possible for development.
...
9. Set version nummer in _readme.txt_ and _connector-for-propstack.php_.
...
Translations are managed in the WordPress repository: https://translate.wordpress.org/projects/wp-plugins/connector-for-propstack/
...
`wp i18n make-pot . languages/connector-for-propstack.pot --exclude=blocks/single/src/,blocks/archive/src/,blocks/broker-field/src/,blocks/description/src/,blocks/archive/src/,blocks/field/src/,blocks/filter/src/,blocks/gallery/src/,svn/`
...
`vendor/bin/phpcs --extensions=php --ignore=*/vendor/*,*/build/*,*/node_modules/*,*/blocks/*,*/svn/*,*/example/*,*/tests/* --standard=WordPress-VIP-Go .`

## Generate documentation

`vendor/bin/wp-documentor parse app --format=markdown --output=doc/hooks.md --prefix=cfprop_ --exclude=Settings.php --exclude=Transients.php`
...
`wp plugin check --error-severity=7 --warning-severity=6 --include-low-severity-errors --categories=plugin_repo --format=json --slug=connector-for-propstack .`
